...
@RegisterDeserializer("BLASTING_RECIPE-MARKDOWN")
public class BlastingRecipeRendererDeserializer implements ItemStackDeserializer {
    ...
    public Object deserialize(String value, Object... initParameters) {
        ...
        if (matcher.find()) {
            ...
            return new CookingRecipeRenderer(itemStack.getItem(), RecipeType.BLASTING);
        }
