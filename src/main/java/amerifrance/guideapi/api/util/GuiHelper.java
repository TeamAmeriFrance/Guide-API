...
public class GuiHelper {
  ...
  /**
   * @param mouseX
   *          - Position of the mouse on the x-axiq
   * @param mouseY
   ...
   * @param x
   *          - The position on the x-axis to draw the itemstack
   * @param y
   *          - The position on the y-axis to draw the itemstack
   */
   ...
   *          - The position on the y-axis to draw the itemstack
   * @param scale
   *          - The scale with which to draw the itemstack
   */
  ...
  /**
   * @param x
   *          - The position on the x-axis to draw the icon
   * @param y
   *          - The position on the y-axis to draw the icon
   * @param width
